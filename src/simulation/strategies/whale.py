...
class WhaleStrategy(BaseStrategy):
    ...
    book and move the price more than it's willing to tolerate.
    """
    ...
    def generate_orders(
        ...
        # Don't take a slice if it would move the price beyond
        # our tolerance -- shrink it instead.
        if fair_price > 0:
